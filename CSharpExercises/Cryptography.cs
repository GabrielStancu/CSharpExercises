...
namespace CSharpExercises
{
    public class Cryptography
    {
        public void Run()
        {
            ...
            Console.WriteLine("\nDecrypted Text: " + Decrypt(cipherText, key));
        }

        public string Encrypt(string plainText, SymmetricAlgorithm key)
        {
        ...
        public string Decrypt(string cipherText, SymmetricAlgorithm key)
        {
